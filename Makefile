...
LDLIBS  = -Wl,--whole-archive peloader/libpeloader.so -Wl,intercept/libhook.a -Wl,intercept/libZydis.a -Wl,intercept/libsubhook.a -Wl,--no-whole-archive
...
testdll_x64: CFLAGS += -g -O0  -fPIC
testdll_x64: CMAKE_FLAGS = -DARCH:STRING=x64 -DCMAKE_BUILD_TYPE=Debug
testdll_x64: testdll_x64.o log/log.o | peloader_x64 intercept
	$(CC) $(CFLAGS) $^ -o $@ $(LDLIBS) $(LDFLAGS)
